...
func (_m *MockTMDb) GetActorMovieCredits(ctx context.Context, id int) (*go_tmdb.PersonMovieCredits, error) {
	ret := _m.Called(ctx, id)

	var r0 *go_tmdb.PersonMovieCredits
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) (*go_tmdb.PersonMovieCredits, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int) *go_tmdb.PersonMovieCredits); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*go_tmdb.PersonMovieCredits)
		}
	}
...
func (_c *MockTMDb_GetActorMovieCredits_Call) Return(_a0 *go_tmdb.PersonMovieCredits, _a1 error) *MockTMDb_GetActorMovieCredits_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTMDb_GetActorMovieCredits_Call) RunAndReturn(run func(context.Context, int) (*go_tmdb.PersonMovieCredits, error)) *MockTMDb_GetActorMovieCredits_Call {
	_c.Call.Return(run)
	return _c
}

// GetActorsByName provides a mock function with given fields: ctx, c, r, names
func (_m *MockTMDb) GetActorsByName(ctx context.Context, c chan<- *go_tmdb.Person, r func() error, names ...string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, chan<- *go_tmdb.Person, func() error, ...string) error); ok {
		r0 = rf(ctx, c, r, names...)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockTMDb_GetActorsByName_Call) Run(run func(ctx context.Context, c chan<- *go_tmdb.Person, r func() error, names ...string)) *MockTMDb_GetActorsByName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(chan<- *go_tmdb.Person), args[2].(func() error), variadicArgs...)
	})
	return _c
}
...
func (_c *MockTMDb_GetActorsByName_Call) RunAndReturn(run func(context.Context, chan<- *go_tmdb.Person, func() error, ...string) error) *MockTMDb_GetActorsByName_Call {
	_c.Call.Return(run)
	return _c
}

// GetActorsFrom provides a mock function with given fields: ctx, c, r, id
func (_m *MockTMDb) GetActorsFrom(ctx context.Context, c chan<- *go_tmdb.Person, r func() error, id int) error {
	ret := _m.Called(ctx, c, r, id)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, chan<- *go_tmdb.Person, func() error, int) error); ok {
		r0 = rf(ctx, c, r, id)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockTMDb_GetActorsFrom_Call) Run(run func(ctx context.Context, c chan<- *go_tmdb.Person, r func() error, id int)) *MockTMDb_GetActorsFrom_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(chan<- *go_tmdb.Person), args[2].(func() error), args[3].(int))
	})
	return _c
}
...
func (_c *MockTMDb_GetActorsFrom_Call) RunAndReturn(run func(context.Context, chan<- *go_tmdb.Person, func() error, int) error) *MockTMDb_GetActorsFrom_Call {
	_c.Call.Return(run)
	return _c
}

// GetAllActorMovieCredits provides a mock function with given fields: ctx, c, r, ids
func (_m *MockTMDb) GetAllActorMovieCredits(ctx context.Context, c chan<- *go_tmdb.PersonMovieCredits, r func() error, ids ...int) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, chan<- *go_tmdb.PersonMovieCredits, func() error, ...int) error); ok {
		r0 = rf(ctx, c, r, ids...)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - c chan<- *go_tmdb.PersonMovieCredits
//   - r func() error
//   - ids ...int
...
func (_c *MockTMDb_GetAllActorMovieCredits_Call) Run(run func(ctx context.Context, c chan<- *go_tmdb.PersonMovieCredits, r func() error, ids ...int)) *MockTMDb_GetAllActorMovieCredits_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(chan<- *go_tmdb.PersonMovieCredits), args[2].(func() error), variadicArgs...)
	})
	return _c
}
...
func (_c *MockTMDb_GetAllActorMovieCredits_Call) RunAndReturn(run func(context.Context, chan<- *go_tmdb.PersonMovieCredits, func() error, ...int) error) *MockTMDb_GetAllActorMovieCredits_Call {
	_c.Call.Return(run)
	return _c
}

// GetAllActors provides a mock function with given fields: ctx, c, r
func (_m *MockTMDb) GetAllActors(ctx context.Context, c chan<- *go_tmdb.Person, r func() error) error {
	ret := _m.Called(ctx, c, r)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, chan<- *go_tmdb.Person, func() error) error); ok {
		r0 = rf(ctx, c, r)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockTMDb_GetAllActors_Call) Run(run func(ctx context.Context, c chan<- *go_tmdb.Person, r func() error)) *MockTMDb_GetAllActors_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(chan<- *go_tmdb.Person), args[2].(func() error))
	})
	return _c
}
...
func (_c *MockTMDb_GetAllActors_Call) RunAndReturn(run func(context.Context, chan<- *go_tmdb.Person, func() error) error) *MockTMDb_GetAllActors_Call {
	_c.Call.Return(run)
	return _c
}
